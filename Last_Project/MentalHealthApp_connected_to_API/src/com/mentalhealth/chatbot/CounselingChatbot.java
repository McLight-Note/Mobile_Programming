...
public class CounselingChatbot {
    ...
    public void show() {
        ...
        System.out.println("    history  — review this conversation");
        System.out.println("    new      — start a fresh session (clears memory)");
        System.out.println("    quit / 0 — return to main menu");
        System.out.println();
        ...
        while (true) {
            ...
            if (input.equalsIgnoreCase("new")) {
                ...
                history.clear();
                System.out.println();
                System.out.printf("  %s: Fresh start! What would you like to talk about?%n", BOT_NAME);
                System.out.println();
                continue;
            }
            ...
            System.out.printf("  %s: thinking...%n", BOT_NAME);
